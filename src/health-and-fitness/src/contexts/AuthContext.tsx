...
interface AuthContextType {
  ...
  signup: (email: string, password: string, username: string) => Promise<{ id: string; email: string; username: string }> | Promise<{ error: { message: string } }>; // Add the signup function
